const zones = {
  norte: {
    name: "Norte",
    coords: [-0.1, -78.45],
    pmValues: [10, 11, 10, 9, 8, 9, 12, 15, 18, 20, 22, 24, 25, 24, 22, 20, 18, 16, 15, 14, 12, 11, 10, 11]
  },
  centroNorte: {
    name: "Centro-Norte",
    coords: [-0.18, -78.48],
    pmValues: [20, 19, 18, 17, 16, 17, 22, 26, 30, 32, 34, 36, 38, 37, 35, 32, 30, 28, 26, 24, 22, 20, 19, 21]
  },
  centro: {
    name: "Centro",
    coords: [-0.23, -78.51],
    pmValues: [25, 24, 24, 23, 22, 22, 27, 33, 38, 42, 45, 48, 50, 49, 47, 44, 42, 39, 37, 35, 33, 30, 28, 12]
  },
  centroSur: {
    name: "Centro-Sur",
    coords: [-0.28, -78.53],
    pmValues: [35, 34, 34, 33, 31, 32, 37, 43, 48, 52, 56, 60, 62, 61, 59, 55, 52, 49, 47, 45, 43, 40, 38, 43]
  },
  sur: {
    name: "Sur",
    coords: [-0.34, -78.56],
    pmValues: [40, 39, 39, 38, 36, 37, 42, 48, 54, 59, 63, 67, 70, 69, 67, 63, 60, 57, 54, 52, 50, 47, 45, 36]
  }
};
